...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    //<intent android:action="android.intent.action.VIEW" android:targetPackage="com.dragar.luka.offbikeworkouts" android:targetClass="com.dragar.luka.offbikeworkouts.Main2Activity" />
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public static class MainPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(final Bundle savedInstanceState) {
            ...
            Preference myPref3 = findPreference("openttssettings");
            ...
            Preference myPref4 = findPreference("downloadmore");
    ...
    public static void sendFeedback(Context context) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"luka.dragarbusiness@gmail.com"});
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        //TODO
                        String textToSay2 = "Great!";
                        textToSpeechSystem.speak(textToSay2, TextToSpeech.QUEUE_ADD, null);

                        dialog.dismiss();
                    }
                });
                builder.setNegativeButton("No(download TTS engine)", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
        ...
        textToSpeechSystem = new TextToSpeech(context, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int ttsInitResult) {
                if (TextToSpeech.SUCCESS == ttsInitResult) {
                    String textToSay = "Can you hear me!";
