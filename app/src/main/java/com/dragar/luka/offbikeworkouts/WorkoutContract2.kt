 ...
 */
interface WorkoutContract2 {
    interface Presenter {
        fun setHostView(callback: View, savedState: Parcelable?, workout: Workout2, ttsEnabled: Boolean)
    ...
    interface View {
        ...
        fun setExercise(workoutPos: Int, exerciseMeta: ExerciseMeta2)
        fun setBreak(workoutPos: Int, nextExerciseMeta: ExerciseMeta2, breakLength: Int)
        fun showFinish()
