 ...
 */
interface WorkoutContract3 {
    interface Presenter {
        fun setHostView(callback: View, savedState: Parcelable?, workout: Workout3, ttsEnabled: Boolean)
    ...
    interface View {
        ...
        fun setExercise(workoutPos: Int, exerciseMeta: ExerciseMeta3)
        fun setBreak(workoutPos: Int, nextExerciseMeta: ExerciseMeta3, breakLength: Int)
        fun showFinish()
