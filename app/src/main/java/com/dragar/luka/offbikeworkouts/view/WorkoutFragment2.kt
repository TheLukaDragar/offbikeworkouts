...
import kotlinx.android.synthetic.main.fragment_workout2.*

class WorkoutFragment2 internal constructor() : Fragment() {

    companion object {
        private const val EXERCISE_META = "exm"
        private const val BREAK_LENGTH = "brl"

        fun newInstance(exerciseMeta: ExerciseMeta2, breakLength: Int): WorkoutFragment2 {
            val fragment = WorkoutFragment2()
            val bundle = Bundle()
    ...
    private var exerciseMeta: ExerciseMeta2? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_workout2, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        activity?.runOnUiThread {
            ...
            exerciseIV.setOnClickListener((activity as WorkoutActivity2).pausePlayListener)
        ...
        val workoutActivity = activity as WorkoutActivity2
