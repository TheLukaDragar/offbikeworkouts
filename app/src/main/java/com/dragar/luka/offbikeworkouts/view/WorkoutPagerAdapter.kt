...
internal class WorkoutPagerAdapter(fragmentManager: FragmentManager, private val workout: Workout) : FragmentStatePagerAdapter(fragmentManager) {
    companion object {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val workoutActivity = (container.context as? WorkoutActivity)
