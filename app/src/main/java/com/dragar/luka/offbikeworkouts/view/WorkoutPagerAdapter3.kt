...
internal class WorkoutPagerAdapter3(fragmentManager: FragmentManager, private val workout: Workout3) : FragmentStatePagerAdapter(fragmentManager) {
    companion object {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val workoutActivity = (container.context as? WorkoutActivity3)
